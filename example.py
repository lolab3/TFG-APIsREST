...
user1 = {
        "get_api_v1_admin": [{"parameters": None, "response": "401", "message": "not allowed"}],
        ...
        "post_api_v1_patient": [{"parameters": "patient1", "response": "200", "message": "Unauthorized"},
                                {"parameters": "patient2", "response": "401", "message": "Unauthorized"}],
        "put_api_v1_patient": [{"parameters": "patient1", "response": "200", "message": "Unauthorized"},
                               {"parameters": "patient2", "response": "401", "message": "Unauthorized"}],
